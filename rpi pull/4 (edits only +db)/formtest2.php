      				...
      				<div class="row collapsible-body">
      					<div class="col s12 m4">
      						<div class="input-field">
          						<input placeholder="e.g. Dahua IP camera" id="product_name" type="text" class="validate">
          						<label for="product_name">Naam product</label>
        					</div>
      					</div>
      					<div class="col s12 m2">
      						<div class="input-field">
          						<input placeholder="e.g. 10" id="quantity" type="text" class="validate">
          						<label for="quantity">Aantal</label>
        					</div>
      					</div>
      					<div class="col s12 m2">
      						<div class="input-field">
          						<input placeholder="e.g. A3IV" id="location" type="text" class="validate">
