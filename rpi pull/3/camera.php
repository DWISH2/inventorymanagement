    ...
    <div class="container"> <!-- Begin container div -->
    	...
    	<div class="row">
    		<div class="col m12">
			    ...
			    <button class="btn btn-info" type="button" id="btn-add"> <span class="glyphicon glyphicon-pencil"></span> &nbsp; Camera toevoegen</button> <!-- Button to add to open add-form -->
			    <button class="btn btn-info" type="button" id="btn-view"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; Bekijk cameras</button>	<!-- Button to view the table when added a new item -->
			    <hr />
    			
				<div class="content-loader"> <!-- Begin content-loader -->

    			<table class="table table-striped table-hover table-responsive" id="example"> <!-- Begin Table -->
    				<thead>
          				<tr>
          					<th>ID</th>
            				<th>Naam</th>
