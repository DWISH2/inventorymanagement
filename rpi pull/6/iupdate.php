					...
					<form method="post" id='iUpdate' class="col s12">
						<div class="row">
							<div class="input-field col s12 m4">
								<input type="text" id="Name" name="inbraakinstallatie_name" class="validate" value='<?php echo $row['iName']; ?>'>
								<label for="Name">Product Naam</label>
							</div>
							<div class="input-field col s12 m4">
								<input type="text" id="Quantity" name="inbraakinstallatie_quantity" class="validate" value='<?php echo $row['iQty']; ?>'>
								<label for="Quantity">Aantal</label>
							</div>
							<div class="input-field col s12 m4">
								<input type="text" id="Location" name="inbraakinstallatie_location" class="validate" value='<?php echo $row['iLoc']; ?>'>
