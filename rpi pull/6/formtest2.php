          ...
          <form  id="inbraak-SaveForm" action="#" method="post">
            <div class="col s12 m4">
              <div class="input-field">
                <input placeholder="e.g. Dahua IP camera" name="iname" id="iname" type="text" class="validate">
                <label for="product_name">Naam product</label>
              </div>
            </div>
            <div class="col s12 m2">
              <div class="input-field">
                <input placeholder="e.g. 10" id="iquantity" name="iquantity" type="text" class="validate">
                <label for="quantity">Aantal</label>
              </div>
            </div>
            <div class="col s12 m2">
              <div class="input-field">
                <input placeholder="e.g. A3IV" id="ilocation" name="ilocation" type="text" class="validate">
            ...
            <tr> <!-- Begin row -->
              <td>
                <?php echo $row['inbraakinstallatie_name']; ?> <!-- Echo inbraakinstallaties_name -->
              </td>
              <td>
                <?php echo $row['inbraakinstallatie_quantity']; ?> <!-- Echo inbraakinstallaties_quantity -->
              </td>
              <td>
                <?php echo $row['inbraakinstallatie_location']; ?>  <!-- Echo inbraakinstallaties_location -->
              </td>
              <td align="center">
                <a id="<?php echo $row['inbraakinstallatie_id']; ?>" class="edit-link" href="#" title="Edit">
                  <!--<img src="/assets/img/edit.png" width="20px" />    Edit button -->
                  <i class="small material-icons">edit</i>
                </a>
              </td>
              <td align="center">
                <a id="<?php echo $row['inbraakinstallatie_id']; ?>" class="delete-link" href="#" title="Delete">
