...
CREATE TABLE `tbl_inbraak` (
  `inbraak_id` int(11) DEFAULT NULL,
  `inbraak_name` varchar(128) DEFAULT NULL,
  `inbraak_quantity` int(32) DEFAULT NULL,
  `inbraak_location` varchar(32) DEFAULT NULL
...
INSERT INTO `tbl_inbraak` VALUES (NULL,'Paradox PIR Single Optic PMD2',1,'B3II');
...
-- Dump completed on 2017-08-22  9:48:59
